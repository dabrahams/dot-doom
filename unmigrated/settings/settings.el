...
command.")
 ...
 '(package-selected-packages
   '(visual-fill-column magit-gh-pulls yaml-mode forge ghub treepy closql emacsql-sqlite emacsql quelpa cask git commander dash ansi package-build shut-up epl f s whitespace-cleanup-mode bazel-mode realgud-lldb easy-jekyll magit-imerge swift-mode magit zerodark-theme marmalade-client flx-ido nzenburn-theme zenburn anti-zenburn-theme labburn-theme zenburn-theme fill-column-indicator flymake-cursor alert find-file-in-git-repo xmlunicode rust-mode yagist use-package twilight-bright-theme twilight-anti-bright-theme pastels-on-dark-theme message-x maxframe ham-mode grep+ gist findr elhome cus-edit+ column-enforce-mode cmake-mode boxquote))
